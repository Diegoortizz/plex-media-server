...
def get_trackers(torrent, hash_string, downloading_torrents, retries=3):
    trackers_url = f'http://192.168.1.15:8080/api/v2/torrents/trackers?hash={hash_string}'
...
def start_download_and_remove_tracker(title, hash_string, tracker_to_remove, session):
    ...
    check_state_url = f'http://192.168.1.15:8080/api/v2/torrents/info?hashes={hash_string}'
    ...
    while elapsed < timeout:
        ...
        if state_response.status_code == 200:
            ...
            if current_state == 'downloading': # dès que le torrent passe en download, on retire le tracker
                ...
                remove_tracker_url = 'http://192.168.1.15:8080/api/v2/torrents/removeTrackers'
                data = {
                    'hash': hash_string,
    ...
    if elapsed >= timeout:
        ...
        pause_url = 'http://192.168.1.15:8080/api/v2/torrents/pause'
...
def reassign_tracker(hash_string, title, tracker_to_add):
    ...
    """
    torrents_url = 'http://192.168.1.15:8080/api/v2/torrents/info'
    ...
    add_tracker_url = 'http://192.168.1.15:8080/api/v2/torrents/addTrackers'
    data = {
        'hash': hash_string,
        'urls': tracker_to_add
    }
    ...
    if add_response.status_code == 200:
        ...
        # Resume the torrent
        resume_url = 'http://192.168.1.15:8080/api/v2/torrents/resume'
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            print(f"{timestamp()} - Authenticated successfully 8080")
            time.sleep(1)
