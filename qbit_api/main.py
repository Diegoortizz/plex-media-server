...
def monitor_torrents():
    ...
    unpaused_torrents = []
    max_unpause_count = 10  # Define how many torrents to unpause at a time
    max_active_torrents = 10  # Define the maximum number of active torrents allowed before unpausing more (with DOWNLADING state)
    unpaused_count = 0
